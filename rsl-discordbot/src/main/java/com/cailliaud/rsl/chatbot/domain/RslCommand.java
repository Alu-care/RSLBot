...
public enum RslCommand {
    ...
    NEW("!raid-new", new SimpleCommand("https://www.alucare.fr/wiki/guide-raid-shadow-legend/comment-bien-debuter-sur-raid-shadow-legends"), "Guide pour les nouveaux", "!raid-tierlist", false),
